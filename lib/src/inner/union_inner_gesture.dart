...
///
/// See [UnionDragGestureRecognizer.onEnd].
...
/// Recognizes movement.
///
/// In contrast to [MultiDragGestureRecognizer], [UnionDragGestureRecognizer]
...
///
/// [UnionDragGestureRecognizer] is not intended to be used directly. Instead,
/// consider using one of its subclasses to recognize specific types for drag
/// gestures.
///
/// [UnionDragGestureRecognizer] competes on pointer events of [kPrimaryButton]
/// only when it has at least one non-null callback. If it has no callbacks, it
/// is a no-op.
///
/// See also:
///
///  * [UnionHorizontalDragGestureRecognizer], for left and right drags.
///  * [UnionVerticalDragGestureRecognizer], for up and down drags.
///  * [PanGestureRecognizer], for drags that are not locked to a single axis.
abstract class UnionDragGestureRecognizer extends OneSequenceGestureRecognizer {
  /// Initialize the object.
  ///
  /// [dragStartBehavior] must not be null.
  ///
  /// {@macro flutter.gestures.gestureRecognizer.kind}
  UnionDragGestureRecognizer({
    Object debugOwner,
  ...
  void handleEvent(PointerEvent event) {
    ...
    if ((event is PointerMoveEvent) &&
        (giveUpPointerEvaluator?.call() ?? false)) {
...
/// See also:
///
///  * [UnionHorizontalDragGestureRecognizer], for a similar recognizer but for
///    horizontal movement.
///  * [MultiDragGestureRecognizer], for a family of gesture recognizers that
///    track each touch point independently.
class UnionVerticalDragGestureRecognizer extends UnionDragGestureRecognizer {
...
/// See also:
///
///  * [UnionVerticalDragGestureRecognizer], for a similar recognizer but for
///    vertical movement.
///  * [MultiDragGestureRecognizer], for a family of gesture recognizers that
///    track each touch point independently.
class UnionHorizontalDragGestureRecognizer extends UnionDragGestureRecognizer {
