...
class UnionInnerScrollable extends StatefulWidget {
  ...
  /// [ScrollAction].
  ///
  /// If not supplied, the [UnionInnerScrollable] will scroll a default amount when a
  ...
  static bool recommendDeferredLoadingForContext(BuildContext context) {
    final _UnionScrollableScope widget = context
        ...
        ?.widget as _UnionScrollableScope;
    if (widget == null) {
      return false;
    }
...
class ScrollAction extends Action<ScrollIntent> {
  ...
  bool isEnabled(ScrollIntent intent) {
    ...
    return focus != null &&
        focus.context != null &&
        Scrollable.of(focus.context) != null;
  }
  ...
  void invoke(ScrollIntent intent) {
    final UnionInnerScrollableState state =
